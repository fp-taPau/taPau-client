...
const Header = ({
  ...
  return (
    <header className="bg-white shadow-lg">
      ...
      {/* For mainpage, show different tabs: delivery, TaPauTogether, pickup, etc.. */}
      {isMainPage && (
            ...
            <Link
              ...
              className={
                tab.label == "Tapau-Together"
                  ? "text-gray-600 p-4 border-4 rounded-lg border-transparent after:content-[''] relative after:absolute after:bottom-0 after:w-35 after:h-[3px] after:bg-black after:rounded-lg"
                  : "text-gray-600 p-4 border-4 rounded-lg border-transparent hover:bg-hoveredContainer hover:text-black relative hover:hover:after:content-[''] after:absolute after:bottom-0 after:left-1/3 after:w-1/3 after:h-[3px] hover:after:bg-black after:rounded-lg"
              }
            >
              <div className="flex items-center">
                {tab.label == "Delivery" && (
