      ...
      <main className="p-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {restaurants.map((restaurant, index) => (
            <div
              key={index}
              className="bg-white border-solid border-[0.25px] border-gray-300 rounded-lg flex flex-col items-center transition-transform transform hover:scale-105"
            >
              <img
              ...
              <div className="w-full px-3">
                ...
                <div className="flex w-full space-x-2 font-bold text-xs mt-3">
                  ...
                  <span className="font-bold mx-1 relative top-[-2px]">.</span>
                  <div className="flex flex-row items-center space-x-1">
                    <img
                      className="text-gray-400 text-sm mb-4 w-6 h-6"
