            ...
            <div className="fleCross1Icon flex justify-around gap-4">
              {optionOne && (
                <button
                  ...
                  className="px-4 py-2 text-md font-semibold text-partyPink hover:bg-red-600 hover:text-white rounded border-2 border-red-600 hover:transition-colors cursor-pointer"
                >
                  {optionOne.label}
                </button>
              )}
